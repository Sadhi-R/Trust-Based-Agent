			...
			<div class="row">
				<div class="col-md-12">
					<div class="mu-featured-area">
						...
						<h3>View And Authorize User Agent Details</h3>
<%@page import="java.sql.*" %>
      ...
      ResultSet rs=st.executeQuery("select * from user_agent");
      %>
      <table style="margin: 100px;" border="2px" style="font-color:white;">
          ...
          <%while(rs.next())
          {
              ...
              <tr>
                  ...
                  <td><a href="uactivate.jsp?username=<%=rs.getString(1)%>">Activate</a></td>
              </tr>
         <% }
}
catch(Exception e)
