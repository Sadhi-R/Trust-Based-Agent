			...
			<div class="row">
				<div class="col-md-12">
					<div class="mu-featured-area">
						<h3> Broker Agent Login</h3>

						
						
						<div class="mu-featured-content">
                                                    <img src="images/broker.jpg" align="right"  width="300px"style="margin-top:0px;">
                                                    <form name="cslogin" action="BrokerAgentLogin.jsp" method="post">
                                                    <table>
