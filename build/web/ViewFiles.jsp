 ...
 <link href="table.css" rel="stylesheet">
  ...
  <body>
	...
	try
	{
            ...
            ResultSet rs=Queries.getExecuteQuery("select * from file where server='"+username+"'");
                             ...
                             while(rs.next())
			{
			 ...
			 <td><font color="green"><%=rs.getString("id")%></font></td>
			   <td><font color="green"><%=rs.getString("owner")%></font></td>
			 <td><font color="green"><%=rs.getString("fname")%>Kb</font></td>
                   
                          <td><font color="green"><%=rs.getString("secret")%></font></td>
