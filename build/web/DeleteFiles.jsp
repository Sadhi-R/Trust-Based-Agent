  ...
  <body>
				...
				<div class="col-md-12">
					<div class="mu-featured-area">
						...
						<div class="mu-featured-content" style="width:1200px;">
                                                    <img src="images/upload.jpg" width="300px" height="300px" align="left">
                                                    <p></p>
                                                    <h2>Delete Files</h2>
                                                    <p>For Delete the file Click On the Filename or  ID</p>
	...
	try
	{
                             ...
                             while(rs.next())
			{
				%>
			 <tr>
                             <td><a href="Delete.jsp?id=<%=rs.getString("id")%>"><%=rs.getString("id")%></a></td>
			  <td><a href="Delete.jsp?id=<%=rs.getString("id")%>"><%=rs.getString("fname")%></a></td>
