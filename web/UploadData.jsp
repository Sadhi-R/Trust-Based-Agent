				...
				<div class="col-md-12">
					<div class="mu-featured-area">
						...
						<div class="mu-featured-content">
                           ...
                           <form action="UploadEnctyptAc" method="post" enctype="multipart/form-data">
                                                <table>
                                                  <tr>
                  <th><font color="black"><b>Choose File:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></font></th>
                  <td><input type="file" name="file"  id="myFile" style="color: red;" onchange="setfilename(this.value)"></td>
              </tr>
            <tr>
                  <td></td>
                  <td></td>
              ...
              <tr>
                  <th>File Name:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
                  <td><input type="text" name="fname" id="wpName" required="" style="width:420px;"></td>
              </tr>
             
              <tr>
                  <th><font color="black"></font>File Data:</th>
                  <td><textarea rows="10" cols="50"  name="content" id="output" style="color: red;" >
