		  ...
		  <div class="container-fluid">
		    ...
		    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		      	<ul class="nav navbar-nav mu-menu navbar-right">
			        ...
			        <li><a href="ProviderAgent.jsp">Provider Agent</a></li>
			        <li><a href="CloudServers.jsp">Cloud Servers</a></li>
		            <li><a href="UserAgent.jsp">User Agent</a></li>
		            <li><a href="BrokerAgent.jsp">Broker Agent</a></li>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="mu-featured-area">
						<h3>Welcome To Provider Agent Login</h3>

						
						
						<div class="mu-featured-content">
                                                    <img src="images/user.jpg" align="right"  width="300px"style="margin-top:20px;">
                                                    <form name="cslogin" action="ProviderAgentLogin.jsp" method="post">
                                                    <table>
                                                    ...
                                                    <tr><td> Password</td><td><input type="password" name="password" required=""></td></tr>
                                                     <tr><td><input type="Submit" Value="Login"></td><td><input type="Reset"></td></tr>
                                                        ...
                                                        <p><a href="ProviderRegister.jsp"><font color="white" size="5">Register</font></a></p>
                                                    </form>
						</div>
