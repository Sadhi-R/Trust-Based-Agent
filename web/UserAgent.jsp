			...
			<div class="row">
				<div class="col-md-12">
					<div class="mu-featured-area">
						<h3>User Agent Login</h3>

						
						
						<div class="mu-featured-content">
                                                    <img src="images/cloudserver.jpg" align="right"  width="300px"style="margin-top:20px;">
                                                    <form name="cslogin" action="UserAgentLogin.jsp" method="post">
                                                    <table>
                                                    ...
                                                    <tr><td> Password</td><td><input type="password" name="password" required=""></td></tr>
                                                     <tr><td><input type="Submit" Value="Login"></td><td><input type="Reset"></td></tr>
                                                        ...
                                                        <p><a href="UserRegister.jsp"><font color="white" size="5">Register</font></a></p>
                                                    </form>
						</div>
