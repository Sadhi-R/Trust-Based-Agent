...
<html lang="en">
  ...
  <body>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="mu-featured-area">
						...
						<div class="mu-featured-content" style="width:1100px;">
                                                    ...
                                                    <p></p>
                                                    <h2>View All Downloaded Files</h2>	
			 ...
			 <tr><th><font color="red">ID</font></th>
                          ...
                          <th><font color="red">Filename</font></th>
                           <th><font color="red">Download Time(ms)</font></th>
	...
	try
	{
            ...
            ResultSet rs=Queries.getExecuteQuery("select * from transactions where username='"+username+"' and task='download'");
                             ...
                             while(rs.next())
			{
			 ...
			 <td><font color="green"><%=rs.getString("filename")%></font></td>
                         <td><font color="green"><%=rs.getString("uploadtime")%> ms</font></td>
