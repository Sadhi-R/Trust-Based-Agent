				...
				<div class="col-md-12">
					<div class="mu-featured-area">
                                            <div class="mu-featured-content" style="width:1100px;">
                                                    ...
                                                    <p></p>
                                                    <h2>Search File Result</h2>
                                            <table>
                                                <tr>
                                                    <th>ID</th><th>FileName</th><th>Owner</th>
                                                </tr>
                                            ...
                                            try{
                                              ...
                                              while(r.next()){
                                                ...
                                                String filename=r.getString("fname");
                                                  ...
                                                  if(content.contains(fname)||filename.equalsIgnoreCase(fname)){
                                                      i=status+1;
                                                   long end=System.nanoTime();  
                                                   
                                                   long stime=TimeUnit.NANOSECONDS.toMillis(end-start);
                                                   
                                                   Queries.getExecuteUpdate("insert into transactions values(null,'"+username+"','"+filename+"','search','"+stime+"',now())");
                                                   
                                                   Queries.getExecuteUpdate("update file set status='"+i+"'where id='"+id+"'");
                                                      %>
                                                      <tr>
                                                          <td><%=id%></td>
                                                           <td><%=filename%></td>
