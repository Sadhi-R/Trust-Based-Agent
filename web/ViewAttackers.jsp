...
<%@page import="java.sql.*" %>
      ...
      ResultSet rs1=st.executeQuery("select * from file where server='"+username+"'");
  ...
  ResultSet rs=st1.executeQuery("select * from attack where fname='"+fname+"'");
  while(rs.next()){
              ...
              <tr>
                 ...
                 <td><a href="Block.jsp?username=<%=rs.getString(2)%>">Block User</a></td>
